...
export default class DealDetailAction {
  public static readonly INITIAL_DETAIL: string =
    'DealDetailAction.INITIAL_DETAIL';
  public static readonly DEAL_FETCHED: string = 'DealDetailAction.DEAL_FETCHED';
  public static readonly DEAL_FETCH_DETAIL: string =
    'DealDetailAction.DEAL_FETCH_DETAIL';
